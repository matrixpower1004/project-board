...
('matrix', 'asdf1234', 'matrixpower', 'matrix@mail.com', 'Thing?', now(), 'matrix', now(), 'matrix')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
    ('matrix2', 'asdf1234', 'matrixpower2', 'matrix2@mail.com', 'Interesting?', now(), 'matrix2', now(), 'matrix2')
;
